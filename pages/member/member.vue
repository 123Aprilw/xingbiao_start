		...
		<view class="user-card">
			...
			<view class="user-info">
				<view class="nickname">
					...
					<text class="user-name">妙木山仙人</text>
				</view>
				<view class="phone">193****5821</view>
			</view>
		...
		<view class="package-section">
			...
			<view class="package-list">
				<view class="package-item active">
					<view class="title">开通永久</view>
					<view class="price">
						<text class="current" style="color: rgba(82, 48, 26, 1);font-family: DIN Alternate;
font-weight: 700;
font-style: Bold;
font-size: 48rpx;
"><text style="font-size: 30rpx;color: rgba(82, 48, 26, 1);">¥</text>128.00</text>
						<text class="original">¥188.00</text>
					</view>
				</view>
				<view class="package-item">
					<view class="title" style="color: rgba(249, 221, 166, 1);font-size: 28rpx;font-weight: 400;">开通一年
					</view>
					<view class="price">
						<text class="current" style="font-size: 48rpx;color: rgba(249, 221, 166, 1);"><text
								style="font-size: 30rpx;color: rgba(249, 221, 166, 1);">¥</text>58.00</text>
						<text class="original">¥88.00</text>
					</view>
				</view>
				<view class="package-item">
					<view class="title" style="color: rgba(249, 221, 166, 1);font-size: 28rpx;font-weight: 400;">开通专栏
					</view>
					<view class="price">
						<text class="current" style="font-size: 48rpx;color: rgba(249, 221, 166, 1);"><text
								style="font-size: 30rpx;color: rgba(249, 221, 166, 1);">¥</text>19.90</text>
						<text class="original">¥58.00</text>
					</view>
				</view>
			</view>
		</view>
		...
		<view class="bottom-bar">
			<view class="price-wrap">
				<text class="original-price">¥188.00</text>
				<text class="current-price">¥128.00</text>
			</view>
